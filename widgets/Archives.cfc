...
component extends="contentbox.model.ui.BaseWidget" singleton{
	...
	*/
	any function renderIt(boolean dropdown=true,boolean showPostCount=false,string title="Archives1",string titleLevel="1"){
		var archives 		= entryService.getArchiveReport();
		var rString			= "";

		saveContent variable="rString"{
			// title
			if( len(arguments.title) ){ writeOutput("<li class='sidebox'><div class='sidetitl clearfix'><h3>#arguments.title#</h3></div><div class='blog-widget'>"); }
			// Build Type
